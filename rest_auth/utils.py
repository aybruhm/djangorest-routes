...
def send_html_to_email(to_list:List, subject:str, template_name, context:Dict, sender=settings.DEFAULT_FROM_EMAIL):
    ...
    msg = EmailMultiAlternatives(subject=subject, body=email_html_message, from_email=sender, to=to_list)
